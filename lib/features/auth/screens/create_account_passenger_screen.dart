...
class CreateAccountPassengerScreen extends StatefulWidget {
  const CreateAccountPassengerScreen({super.key});

  @override
  State<CreateAccountPassengerScreen> createState() =>
      _CreateAccountPassengerScreenState();
}

class _CreateAccountPassengerScreenState
    extends State<CreateAccountPassengerScreen> {
                ...
                child: GestureDetector(
                  onTap: () {
                    Navigator.of(context).pushReplacement(
                      MaterialPageRoute(
                        builder: (_) => const LoginByPhoneScreen(forDriver: false),
                      ),
                    );
                  },
                  child: RichText(
  ...
  Future<void> _handleCreateAccount() async {
    ...
    if (email.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Email is required for backend signup')),
      );
      return;
    }
